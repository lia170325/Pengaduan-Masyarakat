                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" rows="8" cols="50" name="response" id="response" placeholder="Isi tanggapan Anda disini">{{$item->Response->response}}</textarea>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-select select2" name="status">
                                                ...
                                                <option value="kelurahan" @if($item->status == 'kelurahan') selected @endif>Dilanjutkan ke Kelurahan</option>
                                                <option value="perbaikan" @if($item->status == 'perbaikan') selected @endif>Dalam Perbaikan</option>
                                                <option value="finished" @if($item->status == 'finished') selected @endif>Selesai</option>
                                                <option value="rejected" @if($item->status == 'rejected') selected @endif>Ditolak</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
