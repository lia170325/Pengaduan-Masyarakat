            ...
            <div class="vertical-menu">
                <div data-simplebar class="h-100">
                    ...
                    <div class="sidebar-brand">
                        <a href="{{ route('dashboard.index') }}" style="display:inline-block">
                            <img src="{{ asset('assets/images/logo-sintara-white.png') }}" alt="SINTARA">
                        </a>
                    </div>
                            ...
                            @if (Auth::user()->level_id == '1')
                                ...
                                <li>
                                    <a href="javascript:void(0);" class="has-arrow waves-effect">
                                        ...
                                        <span key="t-crypto">Manajemen Akun</span>
                                    </a>
            ...
            <div class="main-content">
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © SINTARA.
                            </div>
                            <div class="col-sm-6">
