...
Route::get('report/day/search', [ReportController::class, 'day_search'])->name('report.day.search');
Route::get('report/day/cetakpdf', [ReportController::class, 'day_pdf'])->name('report.day.pdf');
